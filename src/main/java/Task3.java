public class Task3 {
    ...
    public static void main(String[] args) {
        strForParse = "1,2,4-7,18-21,47-48";
    ...
    static String expandString(String strForParse) throws Exception{
...
//checking range
                if (Integer.parseInt(tmpRange[0]) > Integer.parseInt(tmpRange[1])){
                    ...
                    throw new Exception("The first number in the range should be less, than the second number!");
                    //return res;
                }
